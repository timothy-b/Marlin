...
#define HOTEND_IDLE_TIMEOUT
  ...
  #define HOTEND_IDLE_NOZZLE_TARGET   38     // (°C) Safe temperature for the nozzle after timeout
  #define HOTEND_IDLE_BED_TARGET      38     // (°C) Safe temperature for the bed after timeout
#endif
